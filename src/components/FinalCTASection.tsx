...
export const FinalCTASection: React.FC<FinalCTASectionProps> = ({ onOpenModal }) => {
  return (
    <section className="relative py-14 sm:py-32 bg-[#05030D] border-t border-purple-900/30 overflow-hidden text-center">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <motion.div
          ...
          className="glass-card rounded-3xl p-5 sm:p-14 border border-purple-500/30 shadow-2xl shadow-purple-950/60 relative overflow-hidden bg-[#130D26]/90"
        >
          {/* Top Pill */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-pill border border-purple-500/30 text-xs font-mono text-purple-300 mb-6">
            <Sparkles className="w-3.5 h-3.5 text-purple-400" />
            <span>Next Cohort Starts Monday &bull; Limited Spots</span>
          </div>

          {/* Headline */}
          <h2 className="text-[28px] sm:text-5xl md:text-6xl font-extrabold text-[#F5F3FF] font-['Plus_Jakarta_Sans'] tracking-tight leading-tight">
            You've already taken the first step.{' '}
            <span className="gradient-text-purple">Ready for the next 60?</span>
          </h2>

          <p className="mt-6 text-base sm:text-lg text-[#A8A3B8] max-w-xl mx-auto leading-relaxed">
          ...
          <div className="mt-10 pt-6 border-t border-purple-900/30 flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-xs text-slate-400">
